...
import com.example.zybang.myapplication.com.example.zybang.storeage.PreferenceUtils;
 ...
 */
public class backlayoutActivity extends SwipeBackActivity implements View.OnClickListener {
    ...
    public static Intent createIntent(Context ctx) {
        return new Intent(ctx, backlayoutActivity.class);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_start:
                startActivity(new Intent(backlayoutActivity.this, backlayoutActivity.class));
                break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.backlayout_main, menu);
        return true;
    }
