...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int controlMaxLength =
                this.config.getOrientation() == HORIZONTAL ? sizeWidth : sizeHeight;
        final int controlMaxThickness =
                this.config.getOrientation() == HORIZONTAL ? sizeHeight : sizeWidth;
        ...
        for (int i = 0; i < count; i++) {
            ...
            boolean newLine =
                    lp.newLine || (modeLength != MeasureSpec.UNSPECIFIED && !currentLine.canFit(child));
            if (newLine) {
    ...
    private void applyPositionsToViews(LineDefinition line) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (this.config.getOrientation() == HORIZONTAL) {
                ...
                layoutParams.setPosition(this.getPaddingLeft()
                                + line.getLineStartThickness()
                                + layoutParams.getInlineStartThickness(),
    ...
    private void applyGravityToLines(List<LineDefinition> lines, int realControlLength,
        ...
        int excessThickness =
                realControlThickness - (lastLine.getLineThickness() + lastLine.getLineStartThickness());
        int excessOffset = 0;
        for (int i = 0; i < linesCount; i++) {
    ...
    private void applyGravityToLine(LineDefinition line) {
        ...
        int excessLength = line.getLineLength() - (lastChildLayoutParams.getLength()
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(lp.x + lp.leftMargin, lp.y + lp.topMargin,
                    lp.x + lp.leftMargin + child.getMeasuredWidth(),
 ...
 /* public int getLayoutDirection() {
    ...
    static class LineDefinition {
        ...
        public void addView(int i, View child) {
            ...
            this.lineThicknessWithSpacing =
                    Math.max(this.lineThicknessWithSpacing, lp.getThickness() + lp.getSpacingThickness());
